...
export default function AdminUploadPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl py-20 text-center text-white/60">
      Not found.
    </div>
  );
  }
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-white/60">Uploads audio to R2 and publishes a mix record.</p>
      </div>

      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-4">
        <label className="block">
          <div className="mb-1 text-xs uppercase tracking-widest text-white/60">Admin Secret</div>
          <input
            value={adminSecret}
        ...
        <label className="block">
          <div className="mb-1 text-xs uppercase tracking-widest text-white/60">Title</div>
          <input
            value={title}
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <label className="block">
            <div className="mb-1 text-xs uppercase tracking-widest text-white/60">Slug</div>
            <input
              value={slug}
            ...
            />
            <div className="mt-1 text-xs text-white/40">Leave blank to use: {autoSlug}</div>
          </label>

          <label className="block">
            <div className="mb-1 text-xs uppercase tracking-widest text-white/60">Tags (comma)</div>
            <input
              value={tags}
        ...
        <label className="block">
          <div className="mb-1 text-xs uppercase tracking-widest text-white/60">Description</div>
          <textarea
            value={description}
        ...
        <label className="block">
          <div className="mb-1 text-xs uppercase tracking-widest text-white/60">Tracklist (JSON)</div>
          <textarea
            value={tracklistJson}
        ...
        <label className="block">
          <div className="mb-1 text-xs uppercase tracking-widest text-white/60">Audio file</div>
          <input
            type="file"
            accept="audio/*"
